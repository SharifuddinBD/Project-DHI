...
import FacebookFeed from "./components/FacebookFeed"; // adjust path
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h4 className="text-2xl font-semibold text-green-800 mb-4">হিফজুল কোরআন ও নাযেরা বিভাগের বৈশিষ্ট্যাবলী:</h4>
  ...
  <div className="container mx-auto px-4">
    <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-8 rounded-xl text-center">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-[#065084] bg-opacity-20 p-4 rounded-lg">
